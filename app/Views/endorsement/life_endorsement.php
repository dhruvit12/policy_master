  ...
  <section class="content">
    ...
    <?php if(!empty($quotation)){foreach($quotation as $qs){ ?>
      <form role="form" method="post" action="<?= site_url('quotation/life_store_quatation') ?>">
        <div class="row">
            ...
            <div class="row mt-4">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Client Name<span class="text-danger">*</span> </label>
                    <select class="form-control select2" name="fk_client_id" id="client-name-select" required="true" >
                      ...
                      <option><?php echo $qs['client_name'];?></option>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="fk_insurance_company_id" id="insurance_company_name" required="true">
                      <option><?php echo $qs['insurance_company'];?></option>
                    </select>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="fk_currency_id" id="currency"  id="currency_change" >
                      <option value="" selected="true" ><?php echo $qs['ccy'];?></option>
                    </select>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="x_rate" id="x-rate" value="<?php echo $qs['x_rate'];?>" readonly>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <label>Insurer X Rate<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="insurer_x_rate" id="insurer-x-rate"  value="<?php echo $qs['insurer_x_rate'];?>" readonly>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="insured_name" id="insured_name" value="<?php echo $qs['insured_name'];?>"  >
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label>Address<span class="text-danger">*</span></label>
                    <textarea name="address" id="address" class="form-control"><?php echo $qs['address'];?></textarea>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="date_from" class="form-control datarang" id="date-from" value="<?php echo $qs['date_from'];?>" readonly>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label>Date To<span class="text-danger">*</span></label>
                    <input type="text" class="form-control datarang" name="date_to" id="date-to" value="<?php echo $qs['date_to'];?>" readonly>
                  </div>
                </div>
              </div>
              <!-- Row 2 end here -->
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="covering_details" id="covering-details"><?php echo $qs['covering_details'];?></textarea>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Description of Risk</label>
                    <textarea class="form-control" name="description_of_risk" id="description-of-risk"><?php echo $qs['description_of_risk'];?></textarea>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="first_loss_payee" id="first-loss-payee" class="form-control" value="<?php echo $qs['first_loss_payee'];?>">
                    </div>
                  </div>
                  <!-- /input-group -->
                </div>
                <div class="col-md-2">
                  <div class="form-group mt-4">
                    <div class="form-check">
                      <input class="form-check-input" id="non-renewable" name="non_renewable" value="1" type="checkbox" <?php if($qs['non_renewable']=='1'){ echo "checked";}?>>
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="fk_branch_id" id="branch-name">
                       <option><?php echo $qs['branch_name'];?></option>
                    </select>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="business_by" id="busiess_by"><?php echo $qs['business_by'];?></textarea>
                  </div>
                </div>
              </div>
              <!-- Row 2 end here -->
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="business_type_name" id="business_type">
                      <option><?php echo $qs['business_type_name'];?></option>
                    </select>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group mt-5">
                    <div class="form-check">
                      <input class="form-check-input" id="fronting-business" name="fronting_business" value="1" type="checkbox" readonly="true" <?php if($qs['fronting_business']=='1'){ echo "checked";}?>>
                ...
                <div class="col-md-2">
                  <div class="form-group mt-5">
                    <div class="form-check">
                      <input class="form-check-input" name="borrower" id="borrower" value="1" type="checkbox" <?php if($qs['borrower']=='1'){ echo "checked";}?>>
                ...
                <div class="col-md-4">
                  <div class="form-group" style="display:none;" id="borrower-div">
                    ...
                    <select class="form-control" name="fk_borrower_type_id" id="borrower-type" required="">
                       <option><?php echo $qs['borrow_name'];?></option>
                    </select>
                  </div>
                </div>
              </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="policy-holders-fund1" name="policy_holder_fund" readonly >
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">
                        <label class="text-truncate">Training/Insurance Levy</label>
                        <input type="number" class="form-control" id="insurance-levy1" name="insurance_levy" readonly>
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">
                        <label>Stamp Duty</label>
                        <input type="number" class="form-control" id="stamp-duty1" name="stamp_duty" readonly >
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="withhold-tax1" name="withhold_tax" readonly>
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="commission-rate1"  name="commission_percentage" readonly>
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">
                        <label>Broker Commission</label>
                        <input type="text" name="broker_commission"  id="broker-commission1" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">
                        <label>VAT on Commission</label>
                        <input type="number" class="form-control" id="vat-commission1" name="vat_commission" readonly>
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="addon_premium" name="addon_premium" readonly>
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
                      <label>Total Receivable</label>
                      <input type="text" class="form-control" id="total_receivable" name="total_receivable" disabled="">
                    </div>
                  </div>
                </div>
                <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-2">
             <div class="form-group">
              <label>Addon Premium</label>
              <input type="text" class="form-control" id="addon_premium1" name="addon_premium1" readonly>
            </div>
          ...
          <div class="col-md-2">
            <div class="form-group">
              <label>Total Receivable</label>
              <input type="text" class="form-control" id="total_receivable2" name="total_receivable" readonly>
            </div>
          </div>
        </div>
        <div class="row">
        ...
        <hr/>
        <div class="card-footer float-right">
          <button type="submit" id="form-submit" class="btn btn-primary">Ssave</button>
        </div>
          <?php } ?>
      <?php }  ?></div>
    </div>
