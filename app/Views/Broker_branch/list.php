  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <span>Broker Branch </span>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Broker Branch</a></li>
    ...
    <div  id="collapseExample">
        <div class="card-body">
          <form action="<?=base_url('Broker_branch/search')?>" method="post">
            <div class="form-group row">
              <div class="col-sm-2">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Branch_name</label>
                <input type="text" class="form-control" id="client_name" name="branch_name" value="<?php if(!empty($search_data['branch_name'])){ echo $search_data['branch_name'];}?>">
              </div>
              <div class="col-sm-2">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Broker_Name</label>
                <input type="text" class="form-control" id="registration-no" name="broker_name" placeholder="" value="<?php if(!empty($search_data['broker_name'])){ echo $search_data['broker_name'];}?>">
              </div>
            ...
            <a href="<?php echo base_url('Broker_branch')?>" class="btn btn-primary"> Refresh</a>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form role="form" method="post" action="<?=base_url('Broker_branch/insert')?>">
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="">Broker Name:</label>
              <select class="form-control" name="broker_name_id" required=""><option value="">Please Select </option>
                <?php foreach($broker as $bs){?>
                        <option value="<?php echo $bs['id'];?>"><?php echo $bs['broker_name'];?></option>
                <?php } ?></select>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="branch_name" required="" pattern="[a-zA-Z]+" title="Accepts Only Alphabetic Only" >
            </div>
          </div>
        </div>
        <div class="row">
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <?php if(!empty($list)) {foreach ($list as $key): ?>
            <tr>
             ...
             <a class="btn btn-sm btn-success" href="<?=base_url('Broker_branch/edit/'.$key['id'])?>"><i class="fa fa-edit" aria-hidden="true"></i></a>
                <a href="<?php echo base_url('Broker_branch/delete/')?>/<?php echo $key['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i></a>
      ...
      <form role="form" method="post" action="<?=base_url('Broker_branch/insert')?>">
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="">Broker Name:</label>
              <input type="text" class="form-control" name="broker_name" disabled="">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="">Branch Name:</label>
              <input type="text" class="form-control" name="branch_name" disabled="">
            </div>
          </div>
        </div>
        <div class="row">
...
function open_cancellationModel(id,debitno,client_id) {
  ...
  function viewClientData(id) {
    $.ajax({
      type:"post",
      datatype:"json",
      url:"<?=site_url('Broker_branch/view_client')?>",
      data:{id,id},
