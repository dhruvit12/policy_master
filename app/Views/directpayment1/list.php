  ...
  <div class="content-wrapper">
                ...
                ?>  
                  <select class="form-control" name="branch_name">
                    ...
                    <?php foreach($branches as $bn){?> 
                        <option value="<?php echo $bn['id'];?>" <?php if($bn['id']==$datas['branch_name']){ echo "Selecetd";}?>><?php echo $bn['branch_name'];?></option><?php } ?></select>
                </select>
                 <?php } else {?>
                      <select class="form-control" name="branch_name">
                    <option value="">Select option</option>
      ...
      <div class="table-fluide">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tr>
              ...
              <td>
                <?php if ($key['status'] == 0): ?>
                  <a href="#" class="badge badge-dark">Pendding</a>
              ...
              <td class="project-actions">
                 ...
                 <a class="btn btn-sm btn-success" href="<?=base_url('directpayment/edit/'.$key['id'])?>"><i class="fa fa-paperclip" aria-hidden="true"></i></a>
    ...
    <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="form-group">
                  <label>Bank details:</label>
                  <select class="form-control" name="branch_id"><option>Select option</option><?php foreach($branches as $bn){?> <option value="<?php echo $bn['id'];?>"><?php echo $bn['branch_name'];?></option><?php } ?></select>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
