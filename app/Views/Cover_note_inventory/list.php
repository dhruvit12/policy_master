  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <span>Cover note inverntory </span>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Cover note inverntory</a></li>
        ...
        <div class="card-body">
          <form action="<?=base_url()?>" method="post">
            <div class="form-group row">
              ...
              <div class="col-sm-2">
              <label for="inputEmail3" >Insurance Branch</label>
               <select class="form-control"><option>All</option></select>
              </div>
          
              <div class="col-sm-2">
           
              <label for="inputEmail3" >Book#</label>
            ...
            <div class="col-sm-2">
              ...
              <label for="inputEmail3" >Insurance_class</label>
              <input type="text" name="" class="form-control">
              </div>
            ...
            <div class="form-group row">
               <div class="col-md-3">
                <label>Assigned To Broker</label>
                <select class="form-control"><option>All</option></select>
               </div>
            </div>
            <div class="row">
            ...
            <a href="<?php echo base_url('Cover_note_inventory')?>" class="btn btn-primary"> Refresh</a>
      ...
      <div class="table-fluide">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <div class="row">
              ...
              <button type="submit" class="btn btn-success">Allow To intermediary</button>
            <a href="" class="btn btn-primary">Transfer To Branch</a>
