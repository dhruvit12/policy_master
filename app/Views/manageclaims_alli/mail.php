                                            ...
                                            <div class="modal-body">
                                                <div class="row form-row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text"  class="form-control" readonly="readonly" name="client_name" value="<?php echo $client['client_name'];?>" pattern="[a-zA-Z]+" title="Accepts Only Alphabetic Only">
                                                    </div>
                                                </div>
                                                <div class="row form-row">
                                                    <div class="col-md-12">
                                                        <span>Email :</span><br>
                                                         <?php $data=explode(',',$client['email']);
                                                           ?>
                                                        <input type="email" name="email"  class="form-control" style="height:50px;" value="<?php echo $data[0];?>" required>
                                                ...
                                                <div class="row form-row">
                                                    <div class="col-md-12">
                                                        <span>Body :</span><br>
                                                        <textarea name="message" rows="2" cols="20" id="MainContent_txtBodyCust" class="form-control" style="height:150px;" required=""></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row form-row">
                                                <div class="col-md-12">
                                                    <span>Body :</span><br>
                                                    <textarea name="message" rows="2" cols="20"  class="form-control" style="height:150px;" required=""></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
