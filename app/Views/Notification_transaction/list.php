  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <span>Notification_transaction </span>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Notification_transaction</a></li>
    ...
    <div  id="collapseExample">
        <div class="card-body">
          <form action="<?=base_url('Notification_transaction/search')?>" method="post">
            <div class="form-group row">
              <div class="col-sm-3">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Created_Date</label>
                <input type="date" class="form-control" id="quote-no" name="Reference_no" placeholder="">
              ...
              <label for="inputEmail3" class="col-sm-2 col-form-label">Status</label>
               ...
               <div class="col-sm-3">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Transaction_Reference</label>
                <input type="text" class="form-control" id="date-from" name="date" placeholder="">
              </div>
            </div>
            <div class="row">
              <div class="col-md-3 offset-md-9">
              <button type="submit" class="btn btn-success">  <i class="fa fa-search"></i>&nbsp;&nbsp;Search</button>
            <a href="<?php echo base_url('Notification_transaction')?>" class="btn btn-primary"> Refresh</a>
          ...
          <?php if(!empty($list)) {foreach ($list as $key): ?>
            <tr>
              ...
              <td class="project-actions">
                <button type="button" class="btn btn-primary btn-sm direct-payment" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fas fa-desktop"></i></button>
