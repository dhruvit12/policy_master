    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <a href="<?php echo base_url('General_setup')?>" class="close">  <span aria-hidden="true">&times;</span></a>
   </div>
        <div class="modal-body">
                <form role="form" method="post" action="<?=base_url('general_setup/update_data')?>">
                   <div class="row">
                    <div class="col-md-12">
        ...
        <div class="modal-footer">
            <a href="<?php echo base_url('General_setup')?>" class="btn btn-secondary"
