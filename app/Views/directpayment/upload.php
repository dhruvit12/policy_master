                ...
                <div class="row">
                  <div class="card width-full">
                    <div class="card-body">
                      <div class="row">
                        <div class="mx-auto">
                          <p style="margin-right:5px;">Client Name : <b><?= $directpayment['client_name'] ?></b></p>
                        </div>
                        <div class="mx-auto">
                          <p style="margin-right:5px;">Receipt No. : <b><?= $directpayment['debitnoteno'] ?></b></p>
                        </div>
                        <div class="mx-auto">
                          <p style="margin-right:5px;">Mode : <b><?= $directpayment['mode'] ?></b></p>
                        </div>
                        <div class="mx-auto">
                          <p style="margin-right:5px;">Insurer Company : <b><?= $directpayment['insurance_company'] ?></b></p>
                        </div>
                      </div>
                      <hr/>
                          ...
                          <div class="table-fluide">
                            <table class="table table-bordered table-striped">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td><img src="<?= base_url('public/uploads/directpayment/doc/'.$key['document_name']) ?>" alt="" height="50px"></td>
                    ...
                    <?php endif; ?>
                      <form id="upload-document" action="<?= base_url('directpayment/upload_attach_document') ?>" enctype="multipart/form-data" method="post">
                        <input type="hidden" name="id" value="<?= $directpayment['id'] ?>">
                        <div class="row">
                          <div class="col-md-8">
                            <div style="margin: 4%">
...
$(document).ready(function(){
  ...
  $('.delete-attachment').click(function(){
    ...
    $.ajax({
        type:"post",
        datatype:"json",
        url:"<?=site_url('directpayment/delete_attachment')?>",
        data:{id:id},
