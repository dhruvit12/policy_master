  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <span>Cover note book allotment</span>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Cover note book allotment</a></li>
        ...
        <div class="card-body">
          <form action="<?=base_url()?>" method="post">
            <div class="form-group row">
              ...
              <div class="col-sm-2">
              <label for="inputEmail3" >Allotment</label>
               <input type="text" name="" class="form-control">
               </div>
          
              <div class="col-sm-3">
           
              <label for="inputEmail3" >Broker Name</label>
            ...
            <a href="<?php echo base_url('Cover_notes_book_allotment')?>" class="btn btn-primary"> Refresh</a>
