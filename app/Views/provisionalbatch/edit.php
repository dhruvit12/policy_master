    ...
    <section class="content p-2">
        <div class="container-fluid">
            ...
            <form method="post" action="<?= current_url() ?>">
              <input type="hidden" name="id" value="<?= isset($postdata['id'])?$postdata['id']:'' ?>">
                            ...
                            <div class="row">
                              <div class="col-md-5">
                                <div class="form-group">
                                  ...
                                  <select class="form-control select2" name="insurance_company_id" id="insurance-company-name" required="true">
                                  ...
                                  <table class="table table-bordered table-striped">
                                    <thead>
                                      <tr>
                                        ...
                                        <th>All <input type="checkbox" id="select-all-insurance" name="" value="" required=""> </th>
                                      </tr>
                                    </thead>
                                    <tbody>
