  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
          <span class="text-capitalize" style="font-size: 25px;">Vehicle Insurance Quotation</span>
        </div>
          <div class="col-sm-6">
         ...
         <font color="red">  </font>
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text"  name="date_from" class="form-control" id="date-from" readonly required="true">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <label for="">Date To<span class="text-danger">*</span></label>
                    <input type="text" readonly class="form-control" name="date_to" id="date-to" required="true">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="x_rate"  id="x-rate" readonly required>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <label for="">Insurer X Rate<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="insurer_x_rate" id="insurer-x-rate"  readonly required>
                  </div>
                </div>
                <div class="col-md-1">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-lg-3">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="first_loss_payee">
                    </div>
                  </div>
                  <!-- /input-group -->
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="business_by"></textarea>
                  </div>
                </div>
              </div>
              <!-- Row 2 end here -->
              <div class="row">
               <!--  <div class="col-md-2">
                ...
                <div class="col-md-2">
                  <div class="form-group mt-5">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" name="borrower" id="borrower" value="1">
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text" name="vat_amount" id="vat-amount" class="form-control" readonly required="true">
                     <font color="red">  </font>
                  </div>
                </div>
                <div class="col-md-2">
...
<script type="text/javascript">
  ...
  function get_all_final_receivable() {
    ...
    $.ajax({
      ...
      data:{token:token,administration_charges:administration_charges},
      success:function(data)
      {
        var obj=JSON.parse(data);
        // $('#insertpaneltb').html(data);
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="client" placeholder="Enter Client Name" name="client_name" required="true" pattern="[a-zA-Z]{1,15}" title="Accepts Only Alphabetic Only">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control number-only" id="account-number" placeholder="Account No" name="account_number" value="" required="true" min="0" pattern="[0-9]{9,18}+">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="tin" name="tin" required="true" placeholder="Enter TIN" maxlength="11" pattern="[0-9]{2}" >
                          </div>
                        </div>
                      </div>
                       <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nationality" name="nationality" required="true" placeholder="Enter Nationality" pattern="[a-zA-Z]{1,15}" title="Accepts Only Alphabetic Only">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="inputnin">Place of Birth<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="birth" name="birthplace" value="" required="true" placeholder="Enter place of birth" pattern="[a-zA-Z]{1,10}" title="Accepts Only Alphabetic Only">
                          </div>
                        </div>
                      </div>
                      <hr/>
                      <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="vrn" name="vrn" required="true" placeholder="Enter VRN" pattern="[A-Za-z0-9]{15,16}" title="Accepts Only Alpha-numeric Only">
                          </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="tin" name="tin" required="true" placeholder="Enter TIN/PIN" required=""  pattern="[0-9]{10}" title="Accepts Only number!">
                          </div>
                        </div>
                      </div>
                       <div class="row">
                        <div class="col-md-8">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="contact-person" placeholder="Enter Country" name="country" required=" " pattern="[a-zA-Z]+" title="Accepts Only Alphabetic Only">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label for="tin">Registraction Number<span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="tin" name="registraction_no" required="true" placeholder="Enter Registraction Number" required="" pattern="[0-9]{2,10}" title="Accepts Only number!">
                          </div>
                        </div>
                      </div>
                       <div class="row">
