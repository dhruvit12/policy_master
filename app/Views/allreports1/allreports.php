                        ...
                        <div class="col-md-5">
                          ...
                          <div class="row" style="margin-top:20px;">
                            ...
                            <div class="form-check form-check-inline">
                              ...
                              <img src="<?= base_url('public/assets/images/digital_payment/msword.png') ?>" height="50px" alt="">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-7">
