  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <span>Non Digital Receipts Apprrove </span>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Non Digital Receipts Approve</a></li>
    ...
    <div  id="collapseExample">
        <div class="card-body">
          <form action="<?=base_url('Non_digital_receipts/search')?>" method="post">
            <div class="form-group row">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Company_name</label>
              <div class="col-sm-2">
                 <select class="form-control" name="Company_name" >
                  <?php if(!empty($search_data['company_name'])) { 
                     ?>
                  <option value="">select option</option>
                   <?php foreach($insurancecompany as $ic){?>
                      <option value="<?php echo $ic['insurance_company'];?>" <?php if($search_data['company_name']==$ic['insurance_company']){ echo "selected"; }?>><?php echo $ic['insurance_company'];?></option>
                   <?php } }else{
                    // ?>
                     <option value="">select option</option>
                      <?php foreach($insurancecompany as $ic){?>
                       <option value="<?php echo $ic['insurance_company'];?>"><?php echo $ic['insurance_company'];?></option>
                       <?php
                        } 
                   } ?>
                 </select>
              ...
              <div class="col-sm-2">
                <input type="text" class="form-control" id="receipt_no" name="receipt_no" placeholder="Enter Receipt no" value="<?php if(!empty($search_data['receipt_no'])){ echo $search_data['receipt_no'];}?>">
              </div>
              <label for="inputEmail3" class="col-sm-2 col-form-label">Client name</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="client_name" name="client_name" placeholder="Enter client_name"value="<?php if(!empty($search_data['client_name'])){ echo $search_data['client_name'];}?>">
              </div>
            ...
            <div class="row">
              ...
              <button type="submit" class="btn btn-success"> 
               <i class="fa fa-search"></i>&nbsp;&nbsp;Search</button>
                <a href="<?php echo base_url('non_digital_receipts')?>" class="btn btn-primary"> Refresh</a>
          ...
          <?php if(!empty($list)) {foreach ($list as $key): ?>
            <tr>
              ...
              <!--  <a href="<?=base_url('non_digital_receipts/edit/'.$key['id'])?>" class="btn btn-info btn-sm " ><i class="fas fa-edit" ></i></a> -->
               <a href="<?php echo base_url('non_digital_receipts/delete/')?>/<?php echo $key['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i></a>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <input type="text" name="date_from"  class="form-control" disabled="">
                </div>
              </div>
            </div>
            <div class="row">
