          ...
          <?php if(!empty($list)) { foreach ($list as $key): ?>
            <tr>
              <td class="text-capitalize">
                  <a href="#" class="btn btn-link"><?= $key['debitnoteno'].'/'.$key['tax_invoice'] ?></a><br><a href="<?php echo base_url('receipts')?>" class="btn btn-link">Goto_Receipts</a> 
              </td>
             ...
             <!--    <select class="form-control">
               ...
               <?php if ($key['debitnote_invoice_status']): ?> 
                <button type="button" disabled="" class="btn btn-darkred btn-sm direct-payment" data-id="<?= $key['id'] ?>" data-toggle="modal" data-target="#AddDirectPayment"><i class="fas fa-ticket-alt"></i></button>
                <?php else :?>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  <label>Date :</label>
                  <input type="date" name="date" id="dp-date" class="form-control" value="<?php echo date("Y-m-d"); ?>">
                </div>
              </div>
              <div class="col-md-9">
                <div class="form-group" id="InputClient">
                  <label for="exampleFormControlSelect1">Input Client :</label>
                  <select class="form-control" id="dp-client" disabled name="client_id">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control" id="dp-currency" disabled name="currency_id">
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" name="exchange_rate" id="dp-exchange-rate" class="form-control" disabled="">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label for="exampleFormControlSelect1">Base CCY :</label>
                          <input type="text" id="dp-ccy" class="form-control" disabled name="ccy">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="exampleFormControlSelect1">Equivalent Pending Amount :</label>
                          <input type="text" id="dp-equivalent-amount" class="form-control" disabled name="pending_amount">
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="reference_number" id="dp-cheque-reference-no" class="form-control">
                </div>
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" id="dp-insurer-receipt-no" name="receipt_number" class="form-control">
                </div>
              </div>
            </div>
          </div>
...
$(document).ready(function(){
  ...
  $.ajax({
      ...
      success:function(data)
      {
        ...
        $("#AddDirectPayment").find("#dp-amount").val(obj.total_receivable);
        $("#AddDirectPayment").find("#dp-current-balance").val(obj.total_receivable);
        $("#AddDirectPayment").find("#dp-exchange-rate").val(obj.rate);
        $("#AddDirectPayment").find("#dp-ccy").val(obj.ccy);
        $("#AddDirectPayment").find("#dp-equivalent-amount").val(obj.total_receivable);
