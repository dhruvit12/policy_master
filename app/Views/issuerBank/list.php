...
<div class="content-wrapper">
    ...
    <div class="collapse" id="collapseExample">
        <div class="card-body">
          <form action="<?=base_url('Issuerbank/search')?>" method="post">
            <div class="form-group row">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Issue_bank_name</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="client-name" name="issuer_bank_name" placeholder="issuer_bank_name"
                value="<?php if(!empty($datas)){ echo $datas['issuer_bank_name'];}?>">
            </div>
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-sm-8 mb-1">
            <div class=" float-sm-right">
                <!-- <a href="issuerbank/add_issuerbank" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a> -->
            ...
            <a href="<?php echo base_url('issuerbank')?>" class="btn btn-primary"> Refresh</a>
        </div>
        <!-- Modal -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Issuer Bank</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form role="form" method="post" action="<?=base_url('issuerbank/store_issuerbank')?>">
                        <!-- Row 2 Start here -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="">Issuer Bank Name<span
                                            class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="client-name"
                                            placeholder="Enter Issuer Bank Name" name="issuer_bank_name" required="" pattern="[a-zA-Z\s]+" title="Accepts Only Alphabetic Only">
                                        </div>
                                        <div class="form-group">
    ...
    <div class="card-body">
        ...
        <div class="table-fluide">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php if (!empty($issuerbank)): ?>
                        <?php $i=1; ?>
                        <?php foreach ($issuerbank as $key): ?>
                            <tr>
                                <td><?=$i++?></td>
                                <td><?=$key['issuer_bank_name']?></td>
                                ...
                                <td>
                                    ...
                                    <td class="project-actions">
                                        ...
                                        onclick="set_editdata('<?= $key['id']; ?>','<?=$key['issuer_bank_name']?>','<?=$key['description']?>')"
                                        data-target="#currencyModalEdit"> <i class="fas fa-pencil-alt">
                                        </i> Edit </button>
                                        <a href="<?php echo base_url('issuerbank/delete_issuerbank')?>/<?php echo $key['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
