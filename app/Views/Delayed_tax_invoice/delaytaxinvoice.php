  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <span>Delayed Tax Invoice </span>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Delayed Tax Invoice</a></li>
    ...
    <div  id="collapseExample">
        <div class="card-body">
          <form action="<?=base_url('Delayed_tax_invoice/search')?>" method="post">
            <div class="form-group row">
              <div class="col-sm-2">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Client_name</label>
                <input type="text" class="form-control" id="quote-no" placeholder="Client_name" name="client_name" value="<?php if(!empty($datas['client_name'])){ echo $datas['client_name'];}?>">
              </div>
              <div class="col-sm-2">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Debit_no</label>
                <input type="text" class="form-control" id="registration-no" name="debit_no" placeholder="Debit no" value="<?php if(!empty($datas['debit_no'])){ echo $datas['debit_no'];}?>">
              </div>
              <div class="col-sm-3">
                ...
                <select class="form-control" name="insurance_company">
                  ...
                  <?php if(!empty($datas['insurance_company'])){
                   foreach($insurance_company as $inc){?>
                    <option value="<?php echo $inc['insurance_company'];?>" <?php if($inc['insurance_company']==$datas['insurance_company']){ echo "selected";}?>><?php echo $inc['insurance_company'];?></option>
                  <?php }?>


                  <?php } else {
                    ?>
                  <?php foreach($insurance_company as $inc){?>
            ...
            <a href="<?php echo base_url('Delayed_tax_invoice')?>" class="btn btn-primary"> Refresh</a>
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <?php if(!empty($list)) {foreach ($list as $key): ?>
            <tr>
              ...
              <td class="text-capitalize"><?php echo date('d-m-Y',strtotime($key['created_at']));?></td>
              <td class="text-capitalize"><?php echo $key['client_name'];?></td>
              <td class="text-capitalize"><?php echo $key['total_receivable'];?></td>
              <td class="text-capitalize"><?php echo $key['total_receivable'];?></td>
              <td class="text-capitalize"><?php echo $key['current_balance'];?></td>
              <td class="text-capitalize"><?php echo $key['ccy'];?></td>
              <td class="text-capitalize"><?php echo $key['insurance_company'];?></td>
              <?php if($key['tax_invoice_status']=='1'){?>
                <td class="text-capitalize" ><span style="color: #007bff">Approve</span></td>
              <?php }else{ ?>
                <td class="text-capitalize"><span style="color: #007bff">Delay</span></td>
               <?php } ?> 
             
              <!--   <button type="button" class="btn btn-primary btn-sm
              direct-payment" onclick="viewClientData(<?= $key['id'] ?>)" ><i
              class="fas fa-desktop"></i></button>

               <a
               href="<?=base_url('non_digital_receipts/edit/'.$key['id'])?>"
               class="btn btn-info btn-sm " ><i class="fas fa-edit" ></i></a>
               <button type="button" class="btn btn-danger btn-sm"
               data-toggle="modal" data-target="#CancellationModel"
               onclick="open_cancellationModel('<?= $key['id'] ?>','<?=
               $key['debitnoteno'] ?>','<?= $key['id'] ?>')"> <i class="fa
               fa-trash" aria-hidden="true"></i> </button> <button
               type="button" class="btn btn-secondary btn-sm"
               data-toggle="modal" data-target="#EmailCoverNote" ><i class="fa
  ...
  <div class="modal-dialog modal-lg"  >
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Non Digital Receipts Approve</h5>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleFormControlSelect1">Quote :</label>
                   <input type="text" name="quotation_id" id="dp-amount" class="form-control" value="" disabled="">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="amount" id="dp-amount" class="form-control" disabled="">
                </div>
              </div>
                            <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleFormControlSelect1">Client name:</label>
                  <input type="text" name="client_name" id="dp-amount" class="form-control" disabled="">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group" id="SelectInsurer">
                  <label for="exampleFormControlSelect1">Company name:</label>
                    <input type="text" name="insurance_company" id="dp-amount" class="form-control" disabled="">
