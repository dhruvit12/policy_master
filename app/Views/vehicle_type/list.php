...
<div class="content-wrapper">
    ...
    <div class="collapse" id="collapseExample">
        <div class="card-body">
          <form action="<?=base_url('Vehicle_Type/search')?>" method="post">
            <div class="form-group row">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Vehicle_type_name</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="client-name" name="vehicle_type_name" placeholder="vehicle_type"
...
<div class="card-body">
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-sm-8 mb-1">
            ...
            <a href="<?php echo base_url('Vehicle_Type');?>" class="btn btn-primary"> Refresh</a>
        </div>
        <!-- Modal -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Vehicle Sub Type</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form role="form" method="post" action="<?=base_url('Vehicle_Type/store_vehicle_type')?>">
                        <!-- Row 2 Start here -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body">
        ...
        <div class="table-fluide">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <td class="project-actions">
                                        ...
                                        <a href="<?php echo base_url('Vehicle_Type/delete_vehicle_type')?>/<?php echo $key['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?= site_url('Vehicle_Type/edit_vehicle_type') ?>">
                ...
                <script type="text/javascript">
                    ...
                    $.ajax({
                        type: "post",
                        datatype: "json",
                        url: "<?=site_url('Vehicle_Type/changeStatus')?>",
                        data: {
                            id,
                            id
                        },
                ...
                <script type="text/javascript">
                    ...
                    $(".delete").click(function(){
                        ...
                        $.ajax({
                            type:"post",
                            datatype:"json",
                            url:"<?=site_url('Vehicle_Type/delete_vehicle_type')?>",
                            data:{id:id},
                            success:function(data)
                            {
                                ctr.remove();
