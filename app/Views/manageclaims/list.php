            ...
            <tr>
              ...
              <td>
                ...
                <td>
                  ...
                  <td>
                    <a class="btn btn-sm btn-primary" href="<?=base_url('manageclaims/view_manageclaims/'.$key['id'])?>"><i class="fa fa-tv" aria-hidden="true"></i></a>
                   <a class="btn btn-sm btn-primary feedback" href="#" id="feedback_data"  data-toggle="modal" data-id="<?= $key['id'] ?>" data-target="#myModal"><i class='far fa-comment'></i></a>

                    <a class="btn btn-sm btn-success" href="<?=base_url('manageclaims/edit_managecliam/'.$key['id'])?>"><i class="fa fa-edit" aria-hidden="true"></i></a>
                    <a href="<?= base_url('export/manageclaims/'.$key['id']) ?>" target="_blank" class="btn btn-info btn-sm print-quotation"><i class="fa fa-print" aria-hidden="true"></i></a>
                    <a href="<?= base_url('Manageclaims/email/'.$key['id']) ?>"  class="btn btn-info btn-sm print-quotation"><i class="fa fa-envelope" aria-hidden="true"></i></i></a>
                   <!--  <a class="btn btn-blueviolet btn-sm upload-quotation"  href="<?=base_url('quotation/attach_document/'.$key['id'])?>"><i class="fa fa-paperclip" aria-hidden="true"></i></a> -->
                    <button onclick="viewClientData(<?= $key['id'] ?>)" class="btn btn-warning btn-sm"  data-toggle="modal" data-id="<?= $key['id'] ?>" data-target="#sattelment"><span class="sattelment" style="font-size: 17px;">$</span></button>
                  <!--   <button type="button" class="btn btn-secondary btn-sm cancel-quotation"><i class="fa fa-check view_assesment" aria-hidden="true"></i></button> -->
                     <a href="<?php echo base_url('manageclaims/delete_managecliam')?>/<?php echo $key['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                  </td>
                </tr>
              <?php endforeach;?>
            <?php endif; ?>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form method="post" action="manageclaims/insert_settlement">
            ...
            <div class="card" style="width:100%;">
              <div class="card-body"  >
                <div class="row">
                   <div class="col-md-3">
                      <label> Excess</label>
                      <select name="excess" class="form-control">
                   ...
                   <div class="col-md-3">
                      ...
                      <input type="number" name="excess_percent" class="form-control" min="0">
                   </div>
                   <div class="col-md-3">
                      <label> Betterment Percent</label>
                      <input type="number" name="betterment_percent" class="form-control" min="0">
                      
                   </div>
                   <div class="col-md-3">
                      <label> Reserve Amount</label>
                      <input type="number" name="reserve_amount" class="form-control" min="0">
              ...
              <div class="card-body">
                <div class="row">
                   <div class="col-md-3">
                      ...
                      <input type="number" name="less_excess_amount" class="form-control" min="0">
                   </div>
                   <div class="col-md-3">
                      <label> Less Bettlement/Depreciation</label>
                      <input type="number" name="less_bettlement_depreciation" class="form-control" min="0">
                   </div>
                   <div class="col-md-3">
                      <label>Young / Inexperience Driver</label>
                      <input type="number" name="inexperience_driver" class="form-control" min="0">
                      
                   </div>
                   <div class="col-md-3">
                      <label> Salvage</label>
                      <input type="number" name="salvage" class="form-control" min="0">
              ...
              <div class="card-body">
                <div class="row">
                   <div class="col-md-3">
                      ...
                      <input type="number" name="sum_assured" class="form-control" min="0">
                  
                      </div>
                   <div class="col-md-3">
                      <label> Actual Loss /Reserve </label>
                      <input type="number" name="actual_loss_reserve" class="form-control" min="0">
                   </div>
                   <div class="col-md-3">
                      <label> Total Deductibles</label>
                      <input type="number" name="total_deductibles" class="form-control" min="0">
                ...
                <div class="row">
                   ...
                   <div class="col-md-3">
                      ...
                      <input type="number" name="total_amount_paid" class="form-control" min="0">
                   </div>
                   <div class="col-md-3">
                      <label> Balance Amount</label>
                      <input type="number" name="balance_amount" class="form-control" min="0">
                      
                   </div>
                   <div class="col-md-3">
                      <label> Settlement Date</label>
                      <input type="date" name="settlement_date" class="form-control" min="0">
                 ...
                 <div class="row">
                   <div class="col-md-3">
                      ...
                      <input type="number" name="insured_cliam_amount" class="form-control" min="0">
           ...
           <div class="modal-body">
            ...
            <div class="row " style="border: 1px solid rgb(153, 153, 153); border-image: none;">
              <label class="col-md-4 control-label label-field">
                Contact Name : <input name="client_name" id="client_name" style="border: 1px solid white;" disabled="" >   
              </label>
              <label class="col-md-4 control-label label-field" >
                Mobile :<input name="Mobile" id="client_name" style="border: 1px solid white;" disabled=" " > 
              </label>
               <label class="col-md-4 control-label label-field">
                Email : <input name="email" id="client_name" style="border: 1px solid white;width:200px" disabled="">
                </label>
            </div>
            <br>
            <div class="row">
                ...
                <div class=" jumbotron chat-form" >
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <textarea name="feedback" id="feedback" rows="2" cols="20" class="form-control" placeholder="Type message here.." style="height:80px;"></textarea>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3" style="text-align: right;">
                      ...
                      <!-- <button class="btn btn-default" type="reset" id="clearid">
                      Clear</button> -->
...
<script type="text/javascript">
  ...
  $.ajax({
    ...
    $(".feedback-managecliam").click(function(){
      var id = $(this).data('id');
      var ctr = $(this).closest("tr")
      $('#loder').toggle();
      $.ajax({
        type:"post",
        datatype:"json",
        url:"<?=site_url('manageclaims/feedback')?>",
        data:{id:id},
        success:function(data)
        {
