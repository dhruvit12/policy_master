              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-4">
                    ...
                    <input type="text" name="risk_note" value="<?= isset($postdata['risk_note'])?$postdata['risk_note']:''; ?>" class="form-control">
                  </div>
                  <div class="col-md-1">
                  ...
                  <div class="col-md-3">
                    ...
                    <select class="form-control" name="fk_branch_id" id="branch-name">
                      ...
                      <?php if(!empty($quotation['fk_branch_id'])){?>
                      <?php foreach ($branches as $key): ?>
                        <option value="<?= $key['id'] ?>" <?php if($quotation['fk_branch_id']==$key['id']){ echo "Selected";}?>><?= $key['branch_name'] ?></option>
                      <?php endforeach; } ?>
                    </select>
                  </div>
                  <div class="col-md-3">
                ...
                <div class="row">
                  <div class="col-md-4">
                    ...
                    <input type="text" name="premium_amount" value="<?= isset($quotation['total_receivable'])?$quotation['total_receivable']:''; ?>" class="form-control">
                  </div>
                  <div class="col-md-4">
                    <label class="form-label">Customer Balance Amount</label>
                    <input type="text" name="customer_balance" value="<?= isset($quotation['current_balance'])?$quotation['current_balance']:''; ?>" class="form-control">
                  </div>
                  <div class="col-md-4">
                    <label class="form-label">Insurer Balance Amount</label>
                    <input type="text" name="insurer_balance" value="<?= isset($quotation['insurer_settlement'])?$quotation['insurer_settlement']:''; ?>" class="form-control">
                  </div>
                </div>
                <hr/>
                <div class="row">
                          ...
                          <div class="table-fluide">
                            <table class="table table-bordered table-striped">
                              ...
                              <tr>
                                  ...
                                  <td class="text-capitalize"><?= $quotation['covering_details'] ?></td>
                                  <td>
                ...
                <div class="row">
                  ...
                  <div class="col-md-7">
                    <label class="form-label">Email</label>
                      <input type="email" name="email" value="<?php if(!empty($client['email'])){ $client = explode(',',$client['email']); echo $client[0]; } ?>" class="form-control" >
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="date" name="date_from" value="<?= isset($quotation['date_from'])?date("Y-m-d",strtotime($quotation['date_from'])):''; ?>" class="form-control" >
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">-To-</label>
                        <input type="date" name="date_to" value="<?= isset($quotation['date_to'])?date("Y-m-d",strtotime($quotation['date_to'])):''; ?>" class="form-control" >
                    </div>
                  </div>
                  </div>
                  <div class="col-md-7">
                ...
                <div class="row">
                     ...
                     <select class="form-control" name="vehicle_make_id">
                          <option>Select option</option>
                           <?php foreach($vehicle_maker as $vm) { ?>
                                <option value="<?php echo $vm['id'] ?>"><?php echo $vm['vehicle_maker_name'] ?></option>
                 ...
                 -->    <label class="form-label">Vehicle Model</label>
                     <select class="form-control" name="vehicle_model_id">
                        <option>Select option</option>
                        <?php foreach($vehicle_model as $vml){?>
                               <option value="<?php echo $vml['id'];?>"><?php echo $vml['vehicle_model_name'];?></option>
                        <?php } ?>
                     </select>
                  </div>
                  <div class="col-md-3">
                <!--     <label class="form-label">Policy #</label>
                    ...
                    <select class="form-control" name="vehicle_type_id">
                       ...
                       <?php foreach($vehicle_type as $vt){?>
                           <option value="<?php echo $vt['id'];?>"><?php echo $vt['vehicle_type_name'];?></option>
                       <?php } ?>
                    </select>
                  </div>
                    <div class="col-md-3">
                      <label class="form-label">Client Name</label>
                      <input type="text" name="client_name" value="<?php if(!empty($client_name)){ echo $client_name ;}?>" class="form-control"  >
                  </div>
                </div>
                <div class="row">
                 ...
                 <!--  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                      ...
                      <input type="text" name="insured_name" value="<?= isset($insured_name)?$insured_name:''; ?>" class="form-control " >
                  </div>
                </div>
                <hr/>
                <div class="row">
