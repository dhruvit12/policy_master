                ...
                <div class=" jumbotron chat-form" >
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <textarea name="ctl00$MainContent$txtDisNotes" rows="2" cols="20" id="MainContent_txtDisNotes" class="form-control" placeholder="Type message here.." style="height:80px;"></textarea>
                    </div>
                    <div class="col-md-3">
                      <span>Status :</span>
                      ...
                      <div id="divDisAssessedAmount" style="display: none;">
                        ...
                        <input type="text" id="txtAssessedAmount" class="form-control" onkeypress="return isNumberKey(event)" style="text-align: right;" onchange=" return OnCurrencyValueKeyUp(this);">
                      </div>
                    </div>
                    <div class="col-md-3">
