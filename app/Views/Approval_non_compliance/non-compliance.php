  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <span>Non-Compliance Quotation Approval </span>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Non-Compliance Quotation Approval</a></li>
          ...
          <form action="<?=base_url()?>" method="post">
            <div class="form-group row">
              ...
              <label for="inputEmail3" class="col-sm-2 col-form-label">Company_name</label>
                 <select class="form-control" name="Company_name" value="">
              ...
              <label for="inputEmail3" class="col-sm-2 col-form-label">Branch_name</label>
                <input type="text" class="form-control" id="registration-no" name="vendor-id" placeholder="">
              </div>
          
            <div class="col-sm-2">
           
              <label for="inputEmail3" class="col-sm-2 col-form-label">Quote_No</label>
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-3">
                <br><br>
                 <input type="checkbox"> Pending Quotations
               </div>
            </div>
            <div class="row">
              <div class="col-md-3 offset-md-9">
              <button type="submit" class="btn btn-success">  <i class="fa fa-search"></i>&nbsp;&nbsp;Search</button>
            <a href="<?php echo base_url('Approval_non_compliance')?>" class="btn btn-primary"> Refresh</a>
