  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <span>Intermediary Claim Approvals </span>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Intermediary Claim Approvals</a></li>
        ...
        <div class="card-body">
          <form action="<?=base_url()?>" method="post">
            <div class="form-group row">
              ...
              <div class="col-sm-2">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Broker_claim_ID</label>
                <input type="text" class="form-control" id="quote-no" placeholder="">
              </div>
              <div class="col-sm-2">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Risk_no</label>
                <input type="text" class="form-control" id="registration-no"  placeholder="">
              </div>
          
            <div class="col-sm-2">
           
              <label for="inputEmail3" class="col-sm-2 col-form-label">Cover_no</label>
                <input type="text" class="form-control" >
              </div>
              <div class="col-sm-2">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Cover_information</label>
                <input type="text" class="form-control" >
              </div>
              <div class="col-sm-2">
             <label for="inputEmail3" class="col-sm-2 col-form-label">Status</label>
                <input type="text" class="form-control" id="date-to"  placeholder="">
              </div>
            ...
            <a href="<?php echo base_url('Claim_approval')?>" class="btn btn-primary"> Refresh</a>
      ...
      <div class="table-fluide">
        <table id="example1" class="table table-bordered table-striped">
          <thead>
            <tr>
              <th>Date</th>
              <th>Broker claim id</th>
              <th>broker name</th>
              <th>Risk Note #/Cover Note</th>
