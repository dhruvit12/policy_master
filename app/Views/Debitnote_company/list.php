<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
    ...
    <div class="collapse" id="collapseExample">
        <div class="card-body">
          <form action="<?=base_url('Debitnote_company/search')?>" method="post">
            <div class="form-group row">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Client Name</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="client-name" name="client_name" placeholder="Name Name">
              </div>
              ...
              <select class="form-control" name="insurance_type_name">
                ...
                <?php foreach ($insurance_type as $key): ?>
                                <option value="<?= $key['insurance_type_name'] ?>"><?= $key['insurance_type_name'] ?></option>
                              <?php endforeach; ?>
              </select>
              </div>
                <label for="inputEmail3" class="col-sm-2 col-form-label">Date From</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" autocomplete="off" id="fromDate" name="date_from" >
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                <input type="text" class="form-control" autocomplete="off" id="toDate" name="date_to" >
              </div>
            </div>
      ...
      <div class="table-fluide">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <?php if(!empty($list)){foreach ($list as $key): ?>
            <tr>
              <td class="text-capitalize"><a href="#" class="btn btn-link"></a><br><a href="#" class="btn btn-link"></a> </td>
              ...
              <td class="text-capitalize"><?= $key['client_name'] ?><br>
                <a style="text-align: center;margin-left: -14px;" href="#" onclick="return onclickFunction(<?= $key['id']?>)" >Request_Tax_invoice</a></td>
              <td class="text-capitalize"><?= $key['total_receivable'] ?></td>
              <?php if ($key['credit_allocate'] == "0"): ?>
                <td class="text-capitalize" ><span style="color: #007bff"><?= $key['total_receivable'] ?></span></td>
                <td class="text-capitalize"><?= $key['total_receivable'] - $key['current_balance'] ?></td>
              <?php else: ?>
                <td class="text-capitalize"><span style="color: #007bff"><?= $key['total_receivable']-$key['current_balance'] ?></span></td>
              ...
              <td>
                <?php if ($key['is_cancelled']): ?>
                  <a href="#" class="badge badge-light">Cancelled(Inception)</a><br>
                  <a href="#" class="badge badge-success">Batch</a>
                  <?php else: ?>
                    <a href="#" class="badge badge-success">Active</a><br>
                    <a href="#" class="badge badge-success">Batch</a>
                <?php endif; ?>
              </td>
              <td class="project-actions">
                ...
                <a href="<?= base_url('export/debitnote/') ?>/<?php echo $key['id']; ?>" target="_blank" class="btn btn-info btn-sm print-quotation"><i class="fa fa-print" aria-hidden="true"></i></a>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  <label>Date :</label>
                  <input type="date" name="date" id="dp-date" class="form-control" required="">
                </div>
              </div>
              <div class="col-md-9">
                <div class="form-group" id="InputClient">
                  <label for="exampleFormControlSelect1">Input Client :</label>
                  <select class="form-control" id="dp-client" disabled required="">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="amount" id="dp-amount" class="form-control" required="" pattern="[1-9][0-9]*(\.[0-9]+)?|0+\.[0-9]*[1-9][0-9]" title="Enter Valid Amount">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
