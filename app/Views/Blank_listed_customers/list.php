  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <span>Blank Listed Customers </span>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Blank Listed Customers</a></li>
    ...
    <div  id="collapseExample">
        <div class="card-body">
          <form action="<?=base_url('Blank_listed_customers/search')?>" method="post">
            <div class="form-group row">
              <div class="col-sm-2">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Name</label>
                <input type="text" class="form-control" id="client_name" name="client_name" 
                value="<?php if(!empty($ss['client_name'])){ echo $ss['client_name']; }?>" placeholder="Client name">
              </div>
              <div class="col-sm-2">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Client_Id</label>
                <input type="text" class="form-control" id="registration-no" name="client_id" placeholder="Client_id" 
                value="<?php if(!empty($ss['client_id'])){ echo $ss['client_id'];}?>">
              </div>
          
              <div class="col-sm-2">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Status</label>
              <?php if(!empty($ss['status'])){ ?>
                 <select name="status" class="form-control"><option value="">Select option</option><option value="1" <?php if($ss['status']=='1') { echo "selected";}?>>Sucesss</option><option value="0" <?php if($ss['status']=='0') { echo "selected";}?>>Expired</option></select>
              
              <?php } else { ?>
                 <select name="status" class="form-control"><option value="">Select option</option><option value="1">Sucesss</option><option value="0">Expired</option></select>
              
              <?php } ?>
               <!--  <input type="text" class="form-control" id="date-from" name="status"  placeholder="" value="<?php if(!empty($ss['status'])){ echo $ss['status'];}?>"> -->
              </div>
            </div>
            <div class="row">
              <div class="col-md-3 offset-md-9">
              <button type="submit" class="btn btn-success">  <i class="fa fa-search"></i>&nbsp;&nbsp;Search</button>
            <a href="<?php echo base_url('Blank_listed_customers')?>" class="btn btn-primary"> Refresh</a>
        ...
        <table id="example1" class="table table-bordered table-striped">
          <thead>
            <tr>
              ...
              <th>Client_name</th>
              <th>Client_Type</th>
              <th>Client_Bus_Type </th>
              <th>Status</th>
              <th>Action</th>
            </tr>
          </thead>
          <tbody>
          <?php if(!empty($lists)) {foreach ($lists as $key): ?>
            <tr>
             ...
             <a class="btn btn-sm btn-success" href="<?=base_url('Blank_listed_customers/edit/'.$key['id'])?>"><i class="fa fa-edit" aria-hidden="true"></i></a>
               <a href="<?php echo base_url('Blank_listed_customers/delete/')?>/<?php echo $key['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i></a>
