 ...
 ?>
  <div class="content-wrapper">
    ...
    <div class="collapse" id="collapseExample">
        <div class="card-body">
          <form action="<?=base_url('Receipts/search')?>" method="post">
            <div class="form-group row">
              ...
              <label for="inputEmail3" class="col-sm-2 col-form-label">Receipts No</label>
              <div class="col-sm-2">
              ...
              <div class="col-sm-2">
                <?php if(!empty($datas['branch_name'])) { ?>
                 ...
                 <select class="form-control" name="branch_name">
                  ...
                  <?php foreach($branches as $bs){?><option value="<?php echo $bs['id'];?>" <?php if($bs['id']==$datas['branch_name']){ echo "selected";}?>><?php echo $bs['branch_name'];?></option> <?php } ?>
                </select>
            ...
            <div class="form-group row">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Reference ID</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="registration-no" name="reference_id" placeholder="Reference_id" value="<?php if(!empty($datas['reference_id'])){ echo $datas['reference_id'];}?>">
              </div>
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-sm-8 mb-1">
          <div class="float-sm-right">
            ...
            <a href="<?php echo base_url('receipts')?>" class="btn btn-primary"> Refresh</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="table-fluide">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tr>
              ...
              <td class="text-capitalize"><?php echo $key['receipt'];?></td>
              <td class="text-capitalize"><?php echo $key['date'];?></td>
              <?php if(!empty($key['clientname'])){  
                 ?>
                     <td class="text-capitalize"><?php echo $key['clientname'];?></td>
                   ...
                   <?php  }
              ?>
              <?php if(!empty($key['insurance_company'])){  
                 ?>
              ...
              <td class="text-capitalize"><?php echo $key['refrence_id'];?></td>
              <td>
                <?php if ($key['status'] == 0): ?>
              ...
              <button onclick="viewClientData(<?= $key['id'] ?>)" class="btn btn-primary btn-sm direct-payment"><i class="fa fa-desktop" aria-hidden="true"></i></button> 
               <a class="btn btn-sm btn-success" href="<?=base_url('Receipts/edit/'.$key['id'])?>"><i class="fa fa-edit" aria-hidden="true"></i></a>
                <a href="<?php echo base_url('Receipts/delete/')?>/<?php echo $key['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                <!--  <a href="<?= base_url('export/receipts/'.$key['id']) ?>" target="_blank" class="btn btn-info btn-sm print-quotation"><i class="fa fa-print" aria-hidden="true"></i></a> -->
    ...
    <!-- Modal -->
    <div class="modal fade demo" id="AddReceipts" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
       <form method="post" action="<?php echo base_url('Receipts/insertdata')?>" >
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input type="checkbox" name="user_status"  class="client-insurer-switch change-status" data-id="">
                </div>
              </div>
            </div>
            <hr/>
            <div class="row">
              <div class="col-md-8">
                <div class="form-group" id="InputClient">
                  ...
                  <select class="form-control select2" name="client_name" id="client-name-select" >
                ...
                <div class="form-group" id="SelectInsurer" >
                  ...
                  <select class="form-control select2" name="insurer_name" id="insurance-company-name" >
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" name="rate" class="form-control exchange_rate" aria-describedby="emailHelp" >
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="pending_amount" class="form-control exchange_rates" aria-describedby="emailHelp">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="issuer_bank" required="true">
                    ...
                    <?php foreach($bank as $bs){?><option value="<?php echo $bs['id'];?>"><?php echo $bs['issuer_bank_name'];?></option><?php } ?>
                  </select>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="cheque_number" aria-describedby="emailHelp" required="">
                </div>
                <div class="form-group">
                  <label>Collecting Bank :</label>
                  <select class="form-control" name="collecting_bank" required="">
                    <option value="" selected="true"  disabled="true"> Select One</option>
                    <option>SBI</option>
                  </select>
                </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <select class="form-control" name="branch_id" required=""><option>Select option</option><?php foreach($branches as $bn){?> <option value="<?php echo $bn['id'];?>"><?php echo $bn['branch_name'];?></option><?php } ?></select>
                </div>
              </div>
                 <div class="col-md-6">
                <div class="form-group">
                  <label>Refrence Id :</label>
                  <input type="text" class="form-control" name="refrence_id" aria-describedby="emailHelp" required="">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <a href="<?php echo base_url('receipts')?>" class="close"> <span aria-hidden="true">&times;</span></a>
          </div>
                  <div class="modal-body">
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  <label>Date :</label>
                  <input type="date" name="date" class="form-control" aria-describedby="emailHelp" required="" disabled="">
                </div>
              </div>
              <div class="col-md-4">
                <label for="exampleFormControlSelect1" id="client">Client :</label>
              <select class="form-control select2" name="client_name" id="client_name"  disabled="">
                    <option value="" selected="true" disabled="true"> Select Client</option>
                    <?php if ($client): ?>
                      <?php foreach ($client as $key): ?>
                        <option value="<?= $key['id'] ?>"><?= $key['client_name'] ?></option>
                ...
                <div class="col-md-4">
                    <label for="exampleFormControlSelect1" id="insurer"> Insurer :</label>
                  <select class="form-control select2" name="insurance_company" id="insurance_company" disabled="">
                    <option value="" selected="true" disabled="true"> Select Insurer</option>
                    <?php foreach ($insurancecompany as $key): ?>
                      <option value="<?= $key['id'] ?>"><?= $key['insurance_company'] ?></option>
                    <?php endforeach; ?>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          <label for="exampleFormControlSelect1">Exchange Rate :</label>
                          <input type="text" name="rate" class="form-control exchange_rate" aria-describedby="emailHelp" disabled="">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label for="exampleFormControlSelect1">Base CCY :</label>
                          <input type="text"  name="ccy" class="form-control" aria-describedby="emailHelp" value="TZS" disabled="">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="exampleFormControlSelect1">Equivalent Pending Amount :</label>
                          <input type="text"  name="pending_amount" class="form-control exchange_rates" aria-describedby="emailHelp" disabled="">
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Mode :</label>
                  <select class="form-control" name="mode" required="true" disabled="">
                    <option value="">Select One</option>
                    <?php foreach($mode as $ms){?>
                      <option value="<?php echo $ms['id'];?>"><?php echo $ms['name'];?></option>
                    <?php } ?>
                ...
                <div class="form-group">
                  <label>Issuer Bank :</label>
                  <select class="form-control" name="issuer_bank" required="true" disabled="">
                    <option value="" selected="true" disabled="true"> Select One</option>
                    <?php foreach($bank as $bs){?><option value="<?php echo $bs['id'];?>"><?php echo $bs['issuer_bank_name'];?></option><?php } ?>
                  </select>
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Cheque/ Reference Number :</label>
                  <input type="text" class="form-control" name="cheque_number" aria-describedby="emailHelp" disabled="">
                </div>
                <div class="form-group">
                  <label>Collecting Bank :</label>
           ...
           <!--  <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label>Notes :</label>
                  <textarea class="form-control" name="note" disabled=""></textarea>
                </div>
              </div>
            </div> -->
            <div class="row">
             <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Refrence Id :</label>
                  <input type="text" class="form-control" name="refrence_id" aria-describedby="emailHelp" disabled="">
                </div>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
  ...
  function viewClientData(id) {
    $.ajax({
      type:"post",
      datatype:"json",
      url:"<?=site_url('Receipts/view_client')?>",
      data:{id,id},
      success:function(data)
      {
        var obj = JSON.parse(data);
        $('.bd-example-modal-lgs').find("input[name='date']").val(obj.date);
      //  $(".client").val(obj.client_name);
        if(obj.insurer_name)
        {
         $('.bd-example-modal-lgs').find("select[name='insurance_company']").val(obj.insurer_name);
        }
        else
        {
        ...
        if(obj.client_name)
        {
         $('.bd-example-modal-lgs').find("select[name='client_name']").val(obj.client_name);
        ...
        $('.bd-example-modal-lgs').find("input[name='currency']").val(obj.name);
        $('.bd-example-modal-lgs').find("input[name='rate']").val(obj.rate);
        $('.bd-example-modal-lgs').find("input[name='ccy']").val(obj.code);
        $('.bd-example-modal-lgs').find("input[name='pending_amount']").val(obj.pending_amount);
        $('.bd-example-modal-lgs').find("select[name='mode']").val(obj.mode);
        $('.bd-example-modal-lgs').find("select[name='issuer_bank']").val(obj.issuer_bank);
        ...
        $('.bd-example-modal-lgs').find("textarea[name='note']").val(obj.note);
        $('.bd-example-modal-lgs').find("input[name='refrence_id']").val(obj.refrence_id);
