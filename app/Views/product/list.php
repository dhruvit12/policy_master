        ...
        <div class="card-body">
          <form action="<?=base_url('product/search')?>" method="post">
            <div class="form-group row">
              ...
              <div class="col-sm-2">
                <input type="text" class="form-control" id="client-name" name="product_name" placeholder="product_name"
                value="<?php if(!empty($datas)){ echo $datas['product_name'];}?>">
            </div>
...
<div class="card-body">
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-sm-8 mb-1">
            ...
            <a href="<?php echo base_url('product')?>" class="btn btn-primary"> Refresh</a>
        </div>
        <!-- Modal -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" method="post" action="<?=base_url('product/store_product')?>">
                        <!-- Row 2 Start here -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="">Product Name<span
                                            class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="client-name"
                                            placeholder="Enter Client Name" name="product"  required="" pattern="[a-zA-Z\s]+" title="Accepts Only Alphabetic Only">
                                        </div>
                                        <div class="form-group">
    ...
    <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <td class="project-actions">
                                        ...
                                        onclick="set_editdata('<?= $key['id']; ?>','<?=$key['product']?>','<?=$key['description']?>')"
                                        data-target="#currencyModalEdit"> <i class="fas fa-pencil-alt">
                                        </i> Edit </button>
                                        <a href="<?php echo base_url('product/delete_product')?>/<?php echo $key['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?= site_url('product/edit_product') ?>">
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $.ajax({
                        type: "post",
                        datatype: "json",
                        url: "<?=site_url('product/changeStatus')?>",
                        data: {
                            id,
                            id
                        },
            ...
            <script type="text/javascript">
                function set_editdata(id, product, description) {
                    $('#currencyModalEdit').find("input[name='id']").val(id);
                    $('#currencyModalEdit').find("input[name='product']").val(product);
