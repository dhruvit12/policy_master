  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <span>Z_Report Transactions</span>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Z_Report Transactions</a></li>
        ...
        <div class="card-body">
          <form action="<?=base_url('Digital_transaction/search')?>" method="post">
            ...
            <div class="row">
              ...
              <button type="submit" class="btn btn-success">  <i class="fa fa-search"></i>&nbsp;&nbsp;Print X Report</button>
            <a href="<?php echo base_url('Z_report')?>" class="btn btn-primary"> Refresh</a>
