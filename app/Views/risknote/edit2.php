<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- form start -->
        <form role="form" method="post" name="quotation-add" id="quotation" action="<?= site_url('risknote/update_quotation') ?>">
          <div class="row">
              ...
              <div class="row mt-4">
                <div class="col-md-3 ">
                  <div class="form-group">
                    ...
                    <!-- Large modal -->
                    <select class="form-control" name="fk_client_id" id="client-name-select" >
         ...
         <font color="red">  </font>
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text"  name="date_from" value="<?= $quotation['date_from'] ?>" class="form-control" id="date-from"  required="true">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <label for="">Date To<span class="text-danger">*</span></label>
                    <input type="text"  class="form-control" value="<?= $quotation['date_to'] ?>" name="date_to" id="date-to" required="true">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <label for="">Days<span class="text-danger">*</span></label>
                    <input type="text" class="form-control"  name="days_count" value="<?= $quotation['days_count'] ?>" id="days"  required="true" >
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?= $quotation['x_rate'] ?>" name="x_rate"  id="x-rate"  required>
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <label for="">Insurer X Rate<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="insurer_x_rate" value="<?= $quotation['insurer_x_rate'] ?>" id="insurer-x-rate"   required>
                  </div>
                </div>
                <div class="col-md-1">
                  <div class="form-group">
                ...
                <div class="col-lg-3">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="first_loss_payee" id="first-loss-payee" value="<?= $quotation['first_loss_payee'] ?>">
                    </div>
                  </div>
                  <!-- /input-group -->
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="tra_receipt_date" class="form-control datarang" value="<?= $quotation['tra_receipt_date'] ?>" id="date-from"  required="true" >
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="form-group mt-5">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" name="fronting_business"  <?php if($quotation['fronting_business'] == 1){echo "checked";} ?>>
          ...
          <div class="row mt-3">
            ...
            <hr/>
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="all-total-receivable" name="total_receivable" value="<?= $quotation['total_receivable'] ?>" >
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea  class="form-control" name="score_of_cover" ><?= $quotation['score_of_cover'] ?></textarea>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea  class="form-control" name="terms_and_clause" ><?= $quotation['terms_and_clause'] ?></textarea>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea  class="form-control" name="reject_description" ><?= $quotation['reject_description'] ?></textarea>
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="card-footer float-right">
                ...
                <button type="submit" id="go-submit" class="btn btn-primary">OK</button>
              </div>
            </div>
          </div>
        </form>
