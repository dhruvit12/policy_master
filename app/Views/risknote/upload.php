                ...
                <div class="row">
                  <div class="card width-full">
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="alert alert-<?= $session->getFlashdata('alert_class') ?> alert-dismissible fade show" role="alert" style="margin: auto;width: 75%;margin-bottom: 5px;">
                            <strong><?= $msg ?></strong>
                          ...
                          <div class="table-fluide">
                            <table class="table table-bordered table-striped">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td> <img src="<?= base_url('public/uploads/risknote/doc/'.$key['document_name']) ?>" alt="" height="50px"></td>
                    ...
                    <?php endif; ?>
                      <form id="upload-document" action="<?= base_url('risknote/upload_attach_document') ?>" enctype="multipart/form-data" method="post">
                    ...
                    <div class="card-footer align-end">
                      <a class="btn btn-secondary" href="<?= site_url('risknote') ?>">Exit</a>
                    </div>
                  </div>
                </div>
        </div>
...
$(document).ready(function(){
  ...
  $('.delete-attachment').click(function(){
    ...
    $.ajax({
        type:"post",
        datatype:"json",
        url:"<?=site_url('risknote/delete_attachment')?>",
        data:{id:id},
