              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="commencement_time" value="<?= $quotation['commencement_time'] ?>" class="form-control">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input type="text" name="file_no" value="<?= $quotation['file_no'] ?>" class="form-control">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <label for="">Policy No.</label>
                    <input type="text" name="policy_no" class="form-control" value="<?= $quotation['policy_no'] ?>"required="true" readonly>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
