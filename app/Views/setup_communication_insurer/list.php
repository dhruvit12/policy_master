...
<?php
  ...
  <div class="content-wrapper">
    ...
    <div class="collapse" id="collapseExample">
        <div class="card-body">
          <form action="<?=base_url('Setup_Communication_insurer/search')?>" method="post">
            <div class="form-group row">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Service_type</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="service_type" name="service_type" placeholder="Service_type" value="<?php if(!empty($search_data['service_type'])){ echo $search_data['service_type']; }?>">
            </div>
            <label for="inputEmail3" class="col-sm-2 col-form-label">Communication</label>
            <div class="col-sm-2">
                <input type="text" class="form-control" id="Communication" name="communication" placeholder="Communication" value="<?php if(!empty($search_data['communication'])){ echo $search_data['communication']; }?>">
            </div>
            ...
            <select name="status" class="form-control">
                  ...
                  <option value="0" <?php if($search_data['status']=='0') { echo "selected";} ?>>In-active</option> 
              </select>   
...
<div class="card-body">
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-sm-8 mb-1">
            ...
            <a href="<?php echo base_url('Setup_Communication_insurer')?>" class="btn btn-primary"> Refresh</a>
        </div>
        <!-- Modal -->
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <form role="form" method="post" action="<?= site_url('Setup_Communication_insurer/edit_setup_communication') ?>" enctype='multipart/form-data'>
...
<a href="<?php echo base_url('Setup_Communication_insurer/delete')?>/<?php echo $key['id'];?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash" aria-hidden="true"></i></a>
...
<div class="modal-body">
<form method="post" role="form" action="<?= site_url('Setup_Communication_insurer/edit_setup_communication') ?>" enctype='multipart/form-data'>
<input type="hidden" name="id">
<div class="row">
<div class="col-lg-12">
<div class="row">
...
id="client-name" name="mail_subject" value="" required pattern="[a-zA-Z]+" title="Accepts Only Alphabetic Only">
</div>
</div>
  ...
  <label for="">Client Name : %CLIENT%<span
      ...
      <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  <form method="post" role="form" action="<?= site_url('Setup_Communication_insurer/store_setup_communication') ?>" enctype='multipart/form-data'>
                      <input type="hidden" name="id">
                      <div class="row">
                          <div class="col-lg-12">
                              <div class="row">
          ...
          <div class="col-md-12">
              <div class="form-group">
                  <label for="">Subject (For Email) :<span
                      class="text-danger">*</span></label>
                      <input type="text"  class="form-control"
                      id="client-name" name="mail_subject" required pattern="[a-zA-Z]+" title="Please Enter Alphabethic only">
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                      <label for="">Body<span
                          ...
                          <textarea  class="form-control" id="client-name"
                          placeholder="Enter Address" rows="7"name="content"
                          value="" required  pattern="[a-zA-Z]+"  title="Please Enter Alphabethic only"></textarea>
                      </div>
                  </div>
              </div>
      <center><lable>Body Tags</lable></center>
...
// alert(12);
                                ...
                                type: "post",
                                datatype: "json",
                                url: "<?=site_url('Setup_Communication_insurer/changeStatus')?>",
                                data: {
                                id,
                                id
                                },
            ...
            $(".delete").click(function() {
                ...
                $.ajax({
                    type: "post",
                    datatype: "json",
                    url: "<?=site_url('Setup_Communication_insurer/delete_branch')?>",
                    data: {
                        id: id
                    },
                    success: function(data) {
